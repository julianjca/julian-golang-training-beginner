...
// Source: github.com/julianjca/julian-golang-training-beginner/paymentcodes (interfaces: Repository)
...
func (m *MockRepository) GetByPaymentCode(arg0 string) (golangtraining.PaymentCode, error) {
	m.ctrl.T.Helper()
